...
public class Picture {
	...
	public void rot90DegRight(){
		 RGBColor imageMatrixP[][];
			imageMatrixP = new RGBColor[this.height][this.width];
			for (int w=0; w< this.height; w++){
				for(int h=0; h< this.width; h++){
					imageMatrixP[w][h] = this.imageMatrix[h][this.height - w -1];             
				}
			}
			imageMatrix = imageMatrixP;
		int temp = this.width;
	...
	public void repairPicture(){
		RGBColor imageMatrixP[][];
		imageMatrixP = new RGBColor[this.width][this.height];
		imageMatrixP = this.imageMatrix;
		...
		for (int w=0; w< this.width; w++){
			for(int h=0; h< this.height; h++){
				if(imageMatrixP[w][h].isWhite()) {
					if(w+1 < this.width && !imageMatrixP[w+1][h].isWhite() && !this.imageMatrix[w+1][h].isWhite()){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w+1][h].getRed();
						averageBlue = averageBlue + this.imageMatrix[w+1][h].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w+1][h].getGreen();
					}
					if(w+1 < this.width && h+1 < this.height && !imageMatrixP[w+1][h+1].isWhite() && !this.imageMatrix[w+1][h+1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w+1][h+1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w+1][h+1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w+1][h+1].getGreen();
					}
					if(w+1 < this.width && h-1 >= 0 && !imageMatrixP[w+1][h-1].isWhite() && !this.imageMatrix[w+1][h-1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w+1][h-1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w+1][h-1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w+1][h-1].getGreen();
					}
					if(w-1 >= 0 && !imageMatrixP[w-1][h].isWhite() && !this.imageMatrix[w-1][h].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w-1][h].getRed();
						averageBlue = averageBlue + this.imageMatrix[w-1][h].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w-1][h].getGreen();
					}
					if(w-1 >= 0 && h+1 < this.height &&!imageMatrixP[w-1][h+1].isWhite() &&  !this.imageMatrix[w-1][h+1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w-1][h+1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w-1][h+1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w-1][h+1].getGreen();
					}
					if(w-1 >= 0 && h-1 >= 0 &&!imageMatrixP[w-1][h-1].isWhite() &&!this.imageMatrix[w-1][h-1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w-1][h-1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w-1][h-1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w-1][h-1].getGreen();
					}
					if(h+1 < this.height &&!imageMatrixP[w][h+1].isWhite() && !this.imageMatrix[w][h+1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w][h+1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w][h+1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w][h+1].getGreen();
					}
					if(h-1 >= 0 &&!imageMatrixP[w][h-1].isWhite() && !this.imageMatrix[w][h-1].isWhite() ){
						anzahlDerNachbarn++;
						averageRed = averageRed + this.imageMatrix[w][h-1].getRed();
						averageBlue = averageBlue + this.imageMatrix[w][h-1].getBlue();
						averageGreen = averageGreen + this.imageMatrix[w][h-1].getGreen();
					}
					if(anzahlDerNachbarn == 0){
						continue;
					}else{
					averageRed = averageRed/anzahlDerNachbarn;
					averageGreen = averageGreen/anzahlDerNachbarn;
					averageBlue = averageBlue/anzahlDerNachbarn;
					imageMatrixP[w][h].setRGB(averageRed, averageGreen, averageBlue);
					anzahlDerNachbarn = 0;
					averageRed = 0;
					averageGreen = 0;
					averageBlue = 0;
		...
		this.imageMatrix = imageMatrixP;

			//Pilas ni pixeles blancos ni pixeles reparados
