...
public interface Graph {
	...
	public static final double WEIGHT_NO_EDGE = 0;
	 ...
	 */
	public void addEdge(Node startNode, Node targetNode, double weight);
	 ...
	 *            a positive, non-zero value assigned to this edge
	 */
	public void addEdge(int startNode, int targetNode, double weight);
	 ...
	 *         by addEdge().
	 */
	public double getWeight(Node startNode, Node targetNode);
	 ...
	 */
	double getWeight(int startnode, int endnode);
